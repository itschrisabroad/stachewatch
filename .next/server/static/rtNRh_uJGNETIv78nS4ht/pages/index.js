...
function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      var start = external_moment_default()('2018-10-31');
      ...
      var dayValue = external_moment_default.a.duration(end.diff(external_moment_default()('2018-10-31')));
    ...
    value: function handleChange(selectedOption) {
      ...
      var dayValue = external_moment_default.a.duration(selectedMoment.diff(external_moment_default()('2018-10-31')));
      var dayDiff = dayValue._data.days;
      this.setState({
