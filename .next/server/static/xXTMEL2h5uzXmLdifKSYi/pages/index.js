...
var external_react_select_ = __webpack_require__(5);
...
// CONCATENATED MODULE: ./components/Picture.jsx
...
var Picture_Picture = function Picture(_ref) {
  ...
  return external_react_default.a.createElement(PictureWrapper, {
    className: "pictureWrapper",
    image: image
  });
};

/* harmony default export */ var components_Picture = (Picture_Picture);
...
var PageWrapper = external_styled_components_default.a.section.withConfig({
...
var Sidebar = external_styled_components_default.a.article.withConfig({
...
var SidebarTitle = external_styled_components_default.a.h1.withConfig({
  displayName: "pages__SidebarTitle",
  componentId: "sc-1wbo52z-2"
})(["font-size:2rem;font-weight:300;color:#0f0f0f;margin:0 0 1rem 0;"]);
var SidebarItems = external_styled_components_default.a.ul.withConfig({
  displayName: "pages__SidebarItems",
  componentId: "sc-1wbo52z-3"
})(["margin:0;padding:0;display:flex;flex-flow:column nowrap;"]);
var SidebarItem = external_styled_components_default.a.li.withConfig({
...
var SidebarItemLabel = external_styled_components_default.a.span.withConfig({
...
var StyledDropdown = external_styled_components_default()(external_react_select_default.a).withConfig({
...
var SidebarItemButton = external_styled_components_default.a.a.withConfig({
...
var AbsolutePicture = external_styled_components_default.a.div.withConfig({
...
var CloseIcon = external_styled_components_default.a.i.withConfig({
...
function (_Component) {
  ...
  function Index(props) {
    ...
    _this.state = {
      days: [],
      currentDay: {
        label: external_moment_default()().format('MMMM Do'),
        value: external_moment_default()()
      },
      dayDiff: 0,
      isComparing: false
    };
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      var start = external_moment_default()('2018-11-01');
      var end = external_moment_default()();
      var days = [];
      var day = start;
      ...
      var dayValue = external_moment_default.a.duration(end.diff(external_moment_default()('2018-11-01')));
    ...
    value: function handleChange(selectedOption) {
      ...
      var selectedMoment = external_moment_default()(selectedDay);
      var dayValue = external_moment_default.a.duration(selectedMoment.diff(external_moment_default()('2018-11-01')));
      var dayDiff = dayValue._data.days;
      this.setState({
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(PageWrapper, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "Stachewatch")), external_react_default.a.createElement(components_Picture, {
        image: "/static/".concat(external_moment_default()(this.state.currentDay.value).format('YYYYMMDD'), ".jpg")
      }), external_react_default.a.createElement(Sidebar, null, external_react_default.a.createElement(SidebarTitle, null, "stachewatch"), external_react_default.a.createElement(SidebarItems, null, external_react_default.a.createElement(SidebarItem, null, external_react_default.a.createElement(SidebarItemLabel, null, "Day ", this.state.dayDiff), external_react_default.a.createElement(StyledDropdown, {
        value: this.state.currentDay,
        onChange: this.handleChange.bind(this),
        options: this.state.days,
        className: "dropdown",
        classNamePrefix: "dropdown"
      })), external_react_default.a.createElement(SidebarItem, null, external_react_default.a.createElement(SidebarItemLabel, null, "Donate"), external_react_default.a.createElement(SidebarItemButton, {
        href: "https://ca.movember.com/donate/details?memberId=13850264",
        target: "blank"
      }, "Movember")), external_react_default.a.createElement(SidebarItem, null, external_react_default.a.createElement(SidebarItemLabel, null, "Compare"), external_react_default.a.createElement(StyledDropdown, {
        ...
        className: "dropdown",
        classNamePrefix: "dropdown"
      }))), this.state.isComparing && external_react_default.a.createElement(AbsolutePicture, {
        style: {
          position: 'absolute'
        }
      }, external_react_default.a.createElement(CloseIcon, {
      ...
      }, "close"), external_react_default.a.createElement(components_Picture, {
